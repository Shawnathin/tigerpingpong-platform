...
| Aqua's three grip openings were inspired by the curved sails at Canada Place after Tiger's jagged scratches could not be reproduced cleanly in the mould. | **Locked — owner**                     | Approved product-development history. Keep the telling brief; do not invent a dated discovery scene, CAD process, or engineering detail.                                         |
| Aqua's deep ocean blue connects the paddle to Vancouver and the Pacific.                                                                                  | **Locked — owner, creative direction** | Approved design language. Do not turn it into a material, colourfastness, or manufacturing claim.                                                                                |
...
| Current Tiger PingPong tables do not include paddles or balls.                    | **Locked — owner / commerce**              | State this plainly in the table purchase rail and table add-to-cart confirmation. If a future table package includes accessories, its reviewed catalog record must replace this general rule before publication. |
| A qualifying table unlocks 30% off one eligible play set and one compatible Tiger Table Cover per table quantity. | **Locked — owner / commerce** | Eligible play sets are the Aqua two-paddle/three-ball pack, Aqua four-paddle/three-ball pack, and the Vice four-paddle/six-white-ball package. The cover is not eligible with Plaza Outdoor. Qualification is automatic while the items coexist in the cart; excess quantities stay at regular live price. Eligible play sets are allocated highest-live-price-first, and price promotions do not stack. |
...
| Why Aqua exists     | Schools and community centres were burning through soggy, split paddles; patios and backyards were hard on them too.                                                                            | **Locked — owner**                            | Approved problem statement. Do not add failure rates, customer names, dates, or comparisons Tiger cannot prove.                                                                                                                                                                                         |
| Aqua development    | Tiger used hand-drawn shapes and wooden prototypes, refined the grip, texture, and openings, designed its own custom mould, and did not rush the result.                                        | **Locked — owner**                            | Specialist partners operate production. Do not imply Tiger owns a factory or publish vendor correspondence, quotes, dates, or manufacturing drama.                                                                                                                                                      |
| Aqua first mould    | Aqua was Tiger's first custom injection-moulded paddle and required a multi-step production process.                                                                                            | **Locked — owner**                            | Keep the public telling brief. Do not invent technical steps, tolerances, materials, vendors, or factory ownership.                                                                                                                                                                                     |
| Aqua packaging      | Aqua's retail packaging is 100% recyclable.                                                                                                                                                     | **Locked — owner / packaging evidence**       | This claim applies to the packaging, not automatically to the paddle or every Tiger package. Do not broaden it to recycled content without evidence.                                                                                                                                                    |
| Aqua colour naming  | **Canada Red** is the public colour name.                                                                                                                                                       | **Locked — owner**                            | Existing internal variant keys, option values, SKUs, and checkout mappings containing `coral` remain compatibility identifiers only.                                                                                                                                                                    |
| Aqua pack options   | Single Canada Red, single Ocean Blue, two paddles with three balls, and four paddles with three balls.                                                                                          | **Live catalog / owner-confirmed**            | Prices remain live. Preserve the exact selected option through cart and checkout.                                                                                                                                                                                                                       |
...
| Vice package options | Single Vice Paddle; or four Vice paddles with six white balls.                                                                                                                                 | **Locked — owner / commerce**                 | The bundle regular price is derived from four live single-Vice prices plus one live white six-ball-pack price. Prices and availability remain live. The exact new bundle SKU is pending operations assignment and must not be invented. This package decision does not promote the provisional Vice product story. |
...
| Replacement Parts   | Tiger will help identify the odd little part from product name, photos, description, and order reference when available. Approved common parts may also be sold from the dedicated support hub. | **Locked — owner**                            | Each public part needs approved fit copy, current catalog data, media, price, SKU, and curated rank. Unapproved parts remain support-only and private.                                                                                                                                                  |
| Part 40             | A small opening-system clip used on selected Expo Indoor, Expo Outdoor, Portland Indoor, and Portland Outdoor tables. It can give when a selected table is opened the wrong way.                | **Locked — owner / reviewed catalog**         | First approved online part and most-requested quick fix. Customers self-check the listed fit or email photos before ordering. Once published, current price and availability come from the live catalog. Internal SKU `8123` and the older internal name stay out of public copy. No quantity discount. |
...
- Warranty.
- Care guidance.
- Included ball specification beyond the owner-confirmed three-ball count in each current multi-pack.
