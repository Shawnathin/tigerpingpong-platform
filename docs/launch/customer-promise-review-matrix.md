...
| Shipping timing      | “In stock — ships within 24 business hours.” appears on every product purchase panel                                  | Owner-confirmed V1 handling promise; support must escalate exceptions | Approved by owner       |
| Availability         | Products shown as available are labeled “In stock”; unavailable products and variants are blocked from new checkout    | Catalog availability controls are authoritative; inventory is not reserved | Approved by owner       |
