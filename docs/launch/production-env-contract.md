...
3. Set API variables on `tigerpingpong-platform`:
   - `DATABASE_URL`, `CORS_ORIGIN`, `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, `CHECKOUT_SUCCESS_URL`, `CHECKOUT_CANCEL_URL`, `INTERNAL_ORDERS_API_TOKEN`, `RESEND_API_KEY`, `ORDER_EMAIL_FROM`, and `ORDER_EMAIL_REPLY_TO`.
